...
export const metadata: Metadata = {
  title: "StaffToday.AI - The Only 360 AI Recruitment Agency",
  description: "Save 75% of your time with AI recruitment for Australian construction. Our AI sources, contacts & phone-screens candidates with 95% accuracy.",
  keywords: ["AI recruitment", "construction recruitment Australia", "automated hiring", "candidate sourcing", "recruitment technology"],
  metadataBase: new URL("https://stafftoday.ai/"),
  alternates: {
    canonical: "https://stafftoday.ai/"
  },
  openGraph: {
    title: "StaffToday.AI - AI Recruitment for Construction",
    description: "Save 75% of your time with AI recruitment for Australian construction. 95% accuracy in candidate matching.",
    url: "https://stafftoday.ai/",
    siteName: "StaffToday.AI",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763462197114-krrq0h8t.jpg",
      alt: "StaffToday AI recruitment dashboard"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "StaffToday.AI - AI Recruitment for Construction",
    description: "Save 75% of your time with AI recruitment for Australian construction. 95% accuracy in candidate matching.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763462197114-krrq0h8t.jpg"]
  },
  robots: {
    index: true,
    follow: true
